...
Außerdem gehen wir der Frage nach, was die *Essenz der Computer* ist (*[universelle Turingmaschine](info-universal-turing-machine)*), wenn sie in Form von Smartwatches und Rechenzentren eine sehr unterschiedliche Gestalt annehmen.
...
Er wollte den zunächst nur intuitiv gegebenen Begriff der Berechenbarkeit exakt beschreiben.
...
Die universelle Turingmaschine $U$ (Computer) erhält als Eingabe eine Beschreibung einer andere Turingmaschine $\alpha_T$ (Programm) und die Eingabe $w$ der Turingmaschine $T$.
