...
Die Programmiersprache [Cython](https://cython.org/), mit gleichnamigem [Übersetzer](def-compiler), wurde entwickelt um ``Python``-ähnlichen Code (``Python`` + expliziete Typinformation) in möglicht performanten ``C``-Code zu übersetzen.
